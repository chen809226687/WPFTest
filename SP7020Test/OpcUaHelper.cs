...
namespace ZKSD.Utils
{
    public class OPCUAHelper
    {
        ...
        private void HandleException(string ops, Exception ex)
        {
            throw new Exception(ops, ex);
        }
        ...
        {
            var datavalue = opcUaClient.ReadNode(tag);
            return datavalue?.Value;
        }

        public List<T> ReadNodes<T>(string[] tags)
        {
            return opcUaClient.ReadNodes<T>(tags);
        }

        public bool WritrNode(string tag, object value)
        {
            return opcUaClient.WriteNode(tag, value);
        }

        public bool WriteNodes(string[] tags, object[] values)
        {
            return opcUaClient.WriteNodes(tags, values);
        }
